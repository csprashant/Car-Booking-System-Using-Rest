...
public class CarBookingSystemApplicationTest {
	...
	public void getUsersTest() {
		when(userRepository.findAll()).thenReturn(Stream
				.of(new User("Prashant","Prashant@gmail.com","9211"), new User("Prashant","Prashant@gmail.com","9211")).collect(Collectors.toList()));
		assertEquals(2, iUserService.getAllUserInfo().size());	
	}
	@Test
	public void getVehiclesTest() {
		when(vehicleRepository.findAll()).thenReturn(Stream
				.of(new Vehicle("Tata Magic","Black","CG KL 07 8956"), new Vehicle("Tata Magic","Black","CG KL 07 8956")).collect(Collectors.toList()));
...
/*	@Test
	public void getReservationsTest() {
		...
		when(reservationRepository.findAll()).thenReturn(Stream
				.of(re, re1).collect(Collectors.toList()));
